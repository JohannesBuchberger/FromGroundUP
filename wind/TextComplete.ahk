...
{
	Case randomNumber = 1:
		Send, You are a pice of shit{!}
	Case randomNumber = 2:
		Send, You are a dead end of the evolution{!}
	Case randomNumber = 3:
		Send, Learn to play{!}
	Case randomNumber = 4:
		Send, You are just a steph
}
return
...
:?:!=0m.::⌀
:?:/1m.::∫ ; Integral
:?:/2m.::∬ ; Doppeltes Integral
:?:/3m.::∭ ; Dreifaches Integral
:?:&&m.::⋏ ; und
:?:||m.::⋎ ; oder
:?:\um.::∪  ; Vereinigungsmenge
:?:/um.::∩ ; Schnittmenge
:?:>c=m.::⊆ ; Teilmenge oder gleich
:?:<c=m.::⊇ ; Obermenge oder gleich
:?:<cm.::⊃ ; echte Teilmenge
:?:_>cm.::⊂ ; echte Teilmenge
:?:!<cm.::⊅ ; echte Teilmenge
:?:!>cm.::⊄ ; echte Teilmenge
...
;-------------------------------------------------------------------------------
; Anything below this point was added to the script by the original creator via the Win+H hotkey.
;-------------------------------------------------------------------------------
